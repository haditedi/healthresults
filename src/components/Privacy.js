...
const Privacy = () => {
  ...
  return (
    <section style={{ ...style.paraHead, ...style.padd }}>
      ...
      {/* <p style={style.padd}>Last updated August 18, 2020</p> */}
      <p style={style.pTop}>
        Thank you for choosing to be part of our community at (“company”, “we”,
      ...
      <p style={style.pTop}>
        ...
        discontinue use of our Sites and our services. This privacy policy
        applies to all information collected through our (such as ), and/or any
        related services, sales, marketing or events (we refer to them
        collectively in this privacy policy as the <b>"Sites"</b>).
      </p>
      <p style={style.pTop}>
        <b>
      ...
      <h3 id="top" style={style.pBreak}>
        TABLE OF CONTENTS
      </h3>
      <AnchorLink to="/contact#one">
        <p style={style.pTop}>1. WHAT INFORMATION DO WE COLLECT?</p>
      </AnchorLink>
      <AnchorLink to="/contact#two">
        <p style={style.pTop}>2. HOW DO WE USE YOUR INFORMATION?</p>
      </AnchorLink>
      <AnchorLink to="/contact#three">
        <p style={style.pTop}>
          3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?
        </p>
      </AnchorLink>
      <AnchorLink to="/contact#four">
        <p style={style.pTop}>4. HOW LONG DO WE KEEP YOUR INFORMATION?</p>
      </AnchorLink>
      <AnchorLink to="/contact#five">
        <p style={style.pTop}>5. HOW DO WE KEEP YOUR INFORMATION SAFE?</p>
      </AnchorLink>
      <AnchorLink to="/contact#six">
        <p style={style.pTop}>6. DO WE COLLECT INFORMATION FROM MINORS? </p>
      </AnchorLink>
      <AnchorLink to="/contact#seven">
        <p style={style.pTop}>7. WHAT ARE YOUR PRIVACY RIGHTS?</p>
      </AnchorLink>
      <AnchorLink to="/contact#eight">
        <p style={style.pTop}>8. CONTROLS FOR DO-NOT-TRACK FEATURES</p>
      </AnchorLink>
      <AnchorLink to="/contact#nine">
        <p style={style.pTop}>
          9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
        </p>
      </AnchorLink>
      <AnchorLink to="/contact#ten">
        <p style={style.pTop}>10. DO WE MAKE UPDATES TO THIS POLICY?</p>
      </AnchorLink>
      <AnchorLink to="/contact#eleven">
        <p style={style.pTop}>11. HOW CAN YOU CONTACT US ABOUT THIS POLICY? </p>
      </AnchorLink>
      <AnchorLink to="/contact#twelve">
        <p style={style.pTop}>
          12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM
          YOU?{" "}
        </p>
      </AnchorLink>
      <h3 id="one" style={style.pBreak}>
        1. WHAT INFORMATION DO WE COLLECT?
      </h3>
      <AnchorLink to="/contact#top">
      ...
      <p style={style.pTop}>
        ...
        partners, and other outside sources. We may obtain information about you
      ...
      <p style={style.pTop}>We use the information we collect or receive:</p>
      <p style={style.pTop}>
      ...
      <h3 id="three" style={style.pBreak}>
        3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?
      </h3>
      <AnchorLink to="/contact#top">
        <small>back to top</small>
      ...
      <p style={style.pTop}>
        ...
        laws, to protect your rights, or to fulfill business obligations. We may
        ...
        the Sites. These companies may use information about your visits to our
      ...
      <p style={style.pTop}>
        ...
        require us keeping your personal information for longer than . When we
      ...
      <p style={style.pTop}>
        ...
        information, transmission of personal information to and from our Sites
        is at your own risk. You should only access the services within a secure
        environment.
      </p>
      <h3 id="six" style={style.pBreak}>
      ...
      <p style={style.pTop}>
        ...
        to children under 18 years of age. By using the Sites, you represent
        that you are at least 18 or that you are the parent or guardian of such
        a minor and consent to such minor dependent’s use of the Sites. If we
      ...
      <h3 id="seven" style={style.pBreak}>
      ...
      <p style={style.pTop}>
        ...
        processing before its withdrawal. If you are resident in the European
      ...
      <h3 id="eight" style={style.pBreak}>
      ...
      <p style={style.pTop}>
        ...
        account with the Sites, you have the right to request removal of
        unwanted data that you publicly post on the Sites. To request removal of
      ...
      <h3 id="eleven" style={style.pBreak}>
      ...
      <p style={style.pTop}>
        ...
        request form by <Link to="/contact">clicking here.</Link> We will
